    ...
    i.VERSION = "3.3.7", i.TRANSITION_DURATION = 150, i.DEFAULTS = {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (h) {
                ...
                a = "bottom" == a && p.bottom + c > u.bottom ? "top" : "top" == a && p.top - c < u.top ? "bottom" : "right" == a && p.right + d > u.width ? "left" : "left" == a && p.left - d < u.left ? "right" : a, n.removeClass(f).addClass(a)
            }
            var g = this.getCalculatedOffset(a, p, d, c);
